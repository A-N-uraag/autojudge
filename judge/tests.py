...
class IndexViewTests(TestCase):
    def test_no_contests_index_view(self):
        ...
        self.assertContains(response, "No active contests")
...
class HandlerTests(TestCase):
    ...
    def test_process_update_and_delete_problem(self):
        ...
        status, msg = handler.process_problem(
            ...
            submission_limit=1000, file_exts='.py',
            enable_evaluation=False, is_cmdline=False,
        ...
        self.assertEqual(p.enable_evaluation, False)
